...
import { useUpdateVendor } from "@/features/vendors/api/queries";
...
export function EditVendorDialog({ workspaceId, vendor, open, onOpenChange }: EditVendorDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Update contact information and tax identifiers for this vendor.
          </DialogDescription>
        </DialogHeader>
